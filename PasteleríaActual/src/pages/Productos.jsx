...
//import { useCart } from "../context/ContactContext.jsx";
...
const Productos = () => {
  ...
  // 2. Lógica de Filtrado: Obtenemos las categorías únicas del JSON
  const categories = ["Todos", ...new Set(products.map((p) => p.category))];

  // 3. Filtrar productos basándose en texto y categoría
